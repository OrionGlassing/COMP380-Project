...
const CustomTextInput = ({ value, onChangeText, variant, placeholder, maxCharacters, ...rest }: Props) => {
  const isMultiline = variant === "multiline-fixed" || variant === "multiline-auto";

  const getVariantStyle = () => {
    switch (variant) {
      case "multiline-fixed": return styles.fixedHeight;
      case "multiline-auto": return styles.autoExpanding;
      case "single":
      default: return styles.singleLine;
    }
  };
