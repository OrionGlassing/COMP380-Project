...
export default function ID() {
    ...
    const saved_recipes = useRecipeStore((state) => state.user_recipe_ids);
    ...
    return (
        ...
        <View style={styles.imageContainer} >
          <Image
            style={styles.image}
            source={"https://www.escoffier.edu/wp-content/uploads/2022/03/Chef-Flambeing-Potatoes-in-Professional-Kitchen-768.jpeg"}
            contentFit="cover"
            transition={500}
          />
