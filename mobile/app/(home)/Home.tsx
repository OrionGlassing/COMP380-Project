...
export default function Home() {
  return (
    <ScrollView style={[theme.container.scrollview, {backgroundColor: theme.colors.background}]} bounces={false}>
      <View style={[theme.container.component, { gap: 10, paddingBottom: 20, paddingTop: 40 }]}>
        <Logo />
